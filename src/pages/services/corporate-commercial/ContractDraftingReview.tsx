...
export const ContractDraftingReview: React.FC = () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      description:
        "Professional drafting with comprehensive terms and conditions",
    },
    {
      icon: Scale,
      title: "Legal Review",
      description:
        "Thorough legal review to ensure compliance and risk management",
    },
    {
      icon: Award,
      title: "Final Delivery",
      description: "Delivery of legally vetted contract ready for execution",
    },
  ];
      ...
      <section className="bg-slate-50 py-8 border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-slate-600">
            Professional contract drafting and comprehensive legal review
            services
          </p>
        </div>
      </section>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            >
              <h2 className="text-2xl font-bold text-slate-900 mb-4">
                About Contract Drafting & Review
              </h2>
              <p className="text-slate-700 leading-relaxed mb-6">
                Well-drafted contracts are the foundation of successful business
                relationships. Our comprehensive contract drafting and review
                services ensure your agreements are legally sound, protect your
                interests, and minimize potential disputes.
              </p>
              <p className="text-slate-700 leading-relaxed">
                Whether you need new contracts drafted or existing agreements
                reviewed, our experienced legal team provides thorough analysis
                and professional recommendations to safeguard your business
                interests.
              </p>
            </motion.div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows={3}
                        className="w-full px-3 py-2 border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-slate-500 focus:border-transparent"
                        placeholder="Tell us about your contract requirements..."
                      />
                    </div>
                    ...
                    >
                      {isSubmitting ? "Submitting..." : "Get Contract Services"}
                    </button>
