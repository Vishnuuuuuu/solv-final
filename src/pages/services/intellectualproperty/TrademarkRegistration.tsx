...
export const TrademarkRegistration: React.FC = () => {
  ...
  const steps = [
    {
      ...
      description:
        "We conduct comprehensive searches to ensure your trademark is unique and registrable",
    },
    {
      icon: Users,
      title: "Application Filing",
      description:
        "Our experts prepare and file your trademark application with accurate classification",
    },
    {
      icon: Shield,
      title: "Examination & Response",
      description:
        "We handle examination reports and ensure compliance with trademark office requirements",
    },
    {
      icon: CheckCircle,
      title: "Registration & Certificate",
      description:
        "Receive your trademark registration certificate and ongoing protection guidance",
    },
  ];
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            >
              ...
              <p className="text-slate-700 leading-relaxed mb-6">
                ...
                registration services. A registered trademark gives you
                exclusive rights to use your brand name, logo, and other
                distinctive marks in connection with your goods or services.
              </p>
              <p className="text-slate-700 leading-relaxed">
                Our expert trademark attorneys handle the complete process from
                comprehensive searches to registration and ongoing brand
                protection, ensuring your intellectual property is secure and
                enforceable.
              </p>
            </motion.div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows={3}
                        className="w-full px-3 py-2 border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-slate-500 focus:border-transparent"
                        placeholder="Tell us about your trademark registration requirements..."
                      />
                    </div>
