...
export const LicensingAgreements: React.FC = () => {
  ...
  const benefits = [
    ...
    "Exclusive and non-exclusive licensing deals",
  ...
  const steps = [
    {
      ...
      title: "IP Evaluation",
      description:
        "We assess your intellectual property assets and licensing objectives",
    },
    {
      icon: Users,
      title: "Agreement Drafting",
      description:
        "Our experts draft comprehensive licensing agreements tailored to your needs",
    },
    {
      icon: Shield,
      title: "Negotiation & Review",
      description:
        "We negotiate terms and conduct thorough legal review of all provisions",
    },
    {
      icon: CheckCircle,
      title: "Execution & Management",
      description:
        "Finalize agreements and provide ongoing compliance and enforcement support",
    },
  ];
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            >
              ...
              <p className="text-slate-700 leading-relaxed mb-6">
                Maximize the value of your intellectual property through
                strategic licensing agreements. IP licensing allows you to
                generate revenue from your innovations while maintaining
                ownership and control over your intellectual assets.
              </p>
              <p className="text-slate-700 leading-relaxed">
                Our licensing experts draft comprehensive agreements that
                protect your interests while facilitating profitable
                partnerships and technology transfers across various industries
                and jurisdictions.
              </p>
            </motion.div>
            ...
            >
              <div className="bg-slate-50 rounded-lg p-6 border border-slate-200">
                <h3 className="text-xl font-bold text-slate-900 mb-4">
                  Get Licensing Agreement Services
                </h3>
