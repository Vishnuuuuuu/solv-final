  ...
  const steps = [
    {
      ...
      description:
        "Comprehensive analysis of property documents and legal status",
    },
    {
      icon: Scale,
    ...
    },
    {
      ...
      description:
        "Complete assistance through property registration and transfer",
    },
  ];
      ...
      <section className="bg-slate-50 py-8 border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-slate-600 max-w-2xl">
            Professional property purchase agreement drafting with comprehensive
            buyer protection
          </p>
        </div>
      </section>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            >
              <h2 className="text-2xl font-bold text-slate-900 mb-4">
                About Property Purchase Agreement
              </h2>
              <p className="text-slate-700 leading-relaxed mb-6">
                A property purchase agreement is your shield in property
                transactions. As a buyer, you need robust legal protection to
                ensure your investment is secure, the property title is clear,
                and all terms favor your interests. Our specialized service
                provides comprehensive buyer-focused legal documentation.
              </p>
              <p className="text-slate-700 leading-relaxed">
                Our real estate legal experts craft detailed purchase agreements
                that protect buyers from hidden liabilities, ensure proper due
                diligence, and facilitate smooth property acquisition with
            ...
            >
              ...
              <div className="bg-slate-50 p-6 rounded-lg">
                <p className="text-slate-700 leading-relaxed mb-4">
                  Property purchase is often the largest investment of your
                  lifetime. Our buyer-focused approach ensures you're making an
                  informed decision with complete legal protection.
                </p>
                <ul className="space-y-2 text-slate-700">
                  <li>• Specialized in buyer protection and due diligence</li>
                  <li>
                    • Experience with residential, commercial, and land
                    purchases
                  </li>
                  <li>
                    • Proven track record of identifying potential issues early
                  </li>
            ...
            >
              <div className="bg-slate-50 rounded-lg p-6 border border-slate-200">
                ...
                <p className="text-sm text-slate-600 mb-6">
                  Protect your property investment with our comprehensive legal
                  support.
                </p>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows={3}
                        className="w-full px-3 py-2 border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-slate-500 focus:border-transparent"
                        placeholder="Tell us about your property purchase requirements..."
                      />
                    </div>
