...
export const ChildCustody: React.FC = () => {
  ...
  const steps = [
    {
      ...
      description:
        "Detailed assessment of child custody situation and family dynamics",
    },
    {
      icon: FileText,
      title: "Legal Documentation",
      description:
        "Preparation of custody petition and supporting legal documents",
    },
    {
      icon: Scale,
      title: "Court Proceedings",
      description: "Professional representation in family court proceedings",
    },
    {
      icon: Shield,
      title: "Custody Agreement",
      description:
        "Finalization of custody arrangements and visitation schedules",
    },
  ];
      ...
      <section className="bg-slate-50 py-8 border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-slate-600">
            Child custody and visitation rights legal services
          </p>
        </div>
      </section>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            >
              <h2 className="text-2xl font-bold text-slate-900 mb-4">
                About Child Custody Services
              </h2>
              <p className="text-slate-700 leading-relaxed mb-6">
                Child custody cases require sensitive handling and expert legal
                knowledge. Our experienced family law attorneys prioritize the
                child's best interests while protecting your parental rights and
                ensuring fair custody arrangements.
              </p>
              <p className="text-slate-700 leading-relaxed">
                We provide comprehensive support for all types of custody cases
                including joint custody, sole custody, and visitation rights
                arrangements, working towards solutions that benefit both the
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows={3}
                        className="w-full px-3 py-2 border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-slate-500 focus:border-transparent"
                        placeholder="Tell us about your child custody requirements..."
                      />
                    </div>
