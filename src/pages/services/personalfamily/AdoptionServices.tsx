...
export const AdoptionServices: React.FC = () => {
  ...
  const steps = [
    {
      ...
      description:
        "Comprehensive assessment of adoption eligibility and requirements",
    },
    {
      icon: FileText,
      title: "Document Preparation",
      description:
        "Complete preparation of adoption papers and legal documentation",
    },
    {
      icon: Scale,
      title: "Court Proceedings",
      description:
        "Professional representation in family court for adoption proceedings",
    },
    {
      icon: Shield,
      title: "Adoption Finalization",
      description: "Legal finalization and issuance of adoption certificate",
    },
  ];
      ...
      <section className="bg-slate-50 py-8 border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-slate-600">
            Complete adoption legal procedures and documentation
          </p>
        </div>
      </section>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            >
              ...
              <p className="text-slate-700 leading-relaxed mb-6">
                Adoption is a beautiful way to expand your family while
                providing a loving home to a child in need. Our comprehensive
                adoption services guide you through the complex legal process
                with sensitivity and expertise.
              </p>
              <p className="text-slate-700 leading-relaxed">
                We handle all legal aspects of adoption including court filings,
                documentation, home studies coordination, and representation to
                ensure a smooth and legally sound adoption process.
              </p>
            </motion.div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows={3}
                        className="w-full px-3 py-2 border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-slate-500 focus:border-transparent"
                        placeholder="Tell us about your adoption requirements..."
                      />
                    </div>
                    ...
                    >
                      {isSubmitting ? "Submitting..." : "Get Adoption Services"}
                    </button>
