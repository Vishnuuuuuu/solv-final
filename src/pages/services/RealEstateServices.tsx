      ...
      <section className="bg-slate-50 py-8 border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-slate-600">
            Complete real estate legal services and documentation for all your property needs
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              From property agreements to title verification, we provide comprehensive real estate legal solutions
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {realEstateServices.map((service, index) => (
              <motion.div
                ...
                onClick={() => navigate(`/services/real-estate/${service.slug}`)}
              >
                <div className="mb-4">
      ...
      <section className="py-16 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Expert legal support for all your property transactions and documentation needs
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-2">Property Law Experts</h3>
              <p className="text-slate-600">Specialized legal professionals with extensive real estate experience</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-2">Secure Transactions</h3>
              <p className="text-slate-600">Ensuring all property transactions are legally sound and secure</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-2">End-to-End Support</h3>
              <p className="text-slate-600">Complete assistance from documentation to registration</p>
            </motion.div>
          </div>
        </div>
      </section>
