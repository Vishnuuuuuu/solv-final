      ...
      <section className="bg-slate-50 py-8 border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-slate-600">
            Comprehensive tax planning and compliance services for individuals and businesses
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              From GST registration to income tax filing, we provide end-to-end tax and compliance solutions
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {taxServices.map((service, index) => (
              <motion.div
                ...
                onClick={() => navigate(`/services/tax-compliance/${service.slug}`)}
              >
                <div className="mb-4">
      ...
      <section className="py-16 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Expert tax professionals ensuring compliance and optimization for your business
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-2">Expert Tax Professionals</h3>
              <p className="text-slate-600">Certified tax experts with years of experience in Indian tax laws</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-2">100% Compliance</h3>
              <p className="text-slate-600">Ensuring full compliance with all tax regulations and deadlines</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-slate-600">Quick turnaround times with efficient document processing</p>
            </motion.div>
          </div>
        </div>
      </section>
